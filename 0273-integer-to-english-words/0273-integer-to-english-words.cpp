...
public:
    ...
    //so we will divinde the number into 3 parts (string a , string b, string c)
        //string b will immediately give sthe main thing from mp
        //string a and string c might go into recurssion
