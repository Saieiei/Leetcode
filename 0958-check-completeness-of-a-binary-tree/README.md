<h2><a href="https://leetcode.com/problems/check-completeness-of-a-binary-tree">958. Check Completeness of a Binary Tree</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, determine if it is a <em>complete binary tree</em>.</p>
