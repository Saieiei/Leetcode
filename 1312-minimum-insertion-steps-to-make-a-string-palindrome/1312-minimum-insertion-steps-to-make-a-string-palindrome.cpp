//M3 Tabulation direct 
//to solve this we have to know LCS -> LPS
//after we get the length of LPS, we will sub it with the length of the string
//the ans u get is r just the chars u need to add in the string
